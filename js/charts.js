const TWELVE_API_KEY = '7c964e844bfb4a62ac82cb098ecc6018';  // Your real API key
...
async function fetchStockData(symbol) {
    const url = `https://api.twelvedata.com/time_series?symbol=${symbol}&interval=1min&apikey=${TWELVE_API_KEY}`;
...
// Ensure fetchStockData is exported only once
